...
from vis_utils import debug_plot
...
class ObsRecorder:
    ...
    def save_episode(self):
        ...
        gripper_pcds  = np.stack([o["gripper_pcd"] for o in all_obs]) # (T, 4, 3)
        goal_gripper_pcds     = np.stack([o["goal_gripper_pcd"] for o in all_obs]) # (T, 4, 3)
        ...
        np.savez(
            ...
            goal_gripper_pcds     = goal_gripper_pcds.astype(np.float32),
        ...
        print(f"           gripper_pcds : {gripper_pcds.shape}")
        print(f"           goal_gripper_pcds    : {goal_gripper_pcds.shape}")
